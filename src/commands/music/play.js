...
class PlayCommand extends Command {
    ...
    async exec (message, args) {
        ...
        if(!query) return message.channel.send("You need to provide a song name or links to play!")
        ...
        await player.connect()
            ...
            if(res.loadType === 'PLAYLIST_LOADED') {
				...
				.addField('Duration', moment.duration(res.playlist.duration, 'milliseconds').format("hh:mm:ss"))
